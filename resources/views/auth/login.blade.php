        ...
        <div class="login-content center col-md-10">
            <div class="row container">
                <div class="col-md-5 container">
                    ...
                    <h6 class="mt-3">
                        Don't have an account? <a class="tx-main text-decoration-underline fw-bold" href="/register">Sign-up here</a>
                    </h6>
                    ...
                    <div class="mt-3 login-form p-3 bg-white">
                        ...
                        <div class="">
                            <form method="post" action="{{ route('login') }}">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" type="text" placeholder="Email">
                                @error('email')
                                ...
                                @enderror
                                <br>
                                <input class="form-control @error('password') is-invalid @enderror" value="{{ old('password') }}" class="form-control" name="password" type="password" placeholder="Password">
                                @error('password')
                                <div class="text-danger" role="alert">
                                    <small><i class="fas fa-exclamation-circle"></i> {{ $message }}</small>
                                </div>
